...
function displayFinalSlide(){
	...
	if(numberOfQuestions > score){
		$(stage).append(" <div class='questionText' >You must get all answers correct in order to continue</div><br /><div> <a href=\"page3.html\"><div class='option'>Try Again</div></a> </div>");
	}
	else{
		$(stage).append(" <div> <a href=\"page4.html\"><div class='option'>Next Page</div></a> </div>");
	}
	}
